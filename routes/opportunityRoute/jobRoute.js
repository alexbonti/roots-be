...
var createOpportunityDraft = {
  ...
  config: {
    ...
    handler: function (request, h) {
      ...
      var userData = request.auth && request.auth.credentials && request.auth.credentials.userData || null;
      return new Promise((resolve, reject) => {
        Controller.OpportunityController.createOpportunityDraft(userData,payloadData, function (err, data) {
          console.log(">>>>>>>".err, data)
          if (err) {
            reject(UniversalFunctions.sendError(err));
          } else {
...
var getOpportunityDraft = {
  ...
  config: {
    ...
    handler: function (request, reply) {
      var userData = request.auth && request.auth.credentials && request.auth.credentials.userData || null;
      return new Promise((resolve, reject) => {
        Controller.OpportunityController.getOpportunityDraft(userData,function (error, success) {
          if (error) {
            reject(UniversalFunctions.sendError(error));
          } else {
            resolve(UniversalFunctions.sendSuccess(UniversalFunctions.CONFIG.APP_CONSTANTS.STATUS_MSG.SUCCESS.DEFAULT, success));
  ...
  config: {
    ...
    handler: function (request, reply) {
      ...
      return new Promise((resolve, reject) => {
        ...
        Controller.OpportunityController.changeOpportunityDraft(userData, request.payload, function (err, opportunity) {
          if (!err) {
            return resolve(UniversalFunctions.sendSuccess(UniversalFunctions.CONFIG.APP_CONSTANTS.STATUS_MSG.SUCCESS.DEFAULT, opportunity));
          }
          else {
  ...
  config: {
    ...
    handler: function (request, reply) {
      ...
      return new Promise((resolve, reject) => {
        ...
        Controller.OpportunityController.deleteOpportunityDraft(userData, request.payload, function (err, opportunity) {
          if (!err) {
            return resolve(UniversalFunctions.sendSuccess(UniversalFunctions.CONFIG.APP_CONSTANTS.STATUS_MSG.SUCCESS.DEFAULT, opportunity));
          }
          else {
  ...
  config: {
    ...
    handler: function (request, reply) {
      ...
      return new Promise((resolve, reject) => {
        ...
        Controller.OpportunityController.postDraftToOpportunities(userData, request.payload, function (err, opportunity) {
          if (!err) {
            return resolve(UniversalFunctions.sendSuccess(UniversalFunctions.CONFIG.APP_CONSTANTS.STATUS_MSG.SUCCESS.DEFAULT, opportunity));
          }
          else {

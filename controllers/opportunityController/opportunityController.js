  ...
  async.series(
    [
      function(cb) {
        ...
        Service.EmployerService.getEmployer(
          query,
          projection,
          options,
          function(err, data) {
      ...
      function(cb) {
        ...
        Service.OpportunityService.getOpportunity(
          {
            active: true,
            employerId: customerData._id,
            company: customerData.companyId,
            positionTitle: payloadData.positionTitle,
            employmentType: payloadData.employmentType,
            location: payloadData.location,
            description: payloadData.description,
            seniority: payloadData.seniority,
            startDate: payloadData.startDate,
            endDate: payloadData.endDate,
            industryField: payloadData.industryField
          },
          projection,
          options,
          function(err, data) {
      ...
      function(cb) {
        if (
          ...
          Service.OpportunityService.createOpportunity(dataToSave, function(
            err,
            opportunityDataFromDB
          ) {
  ...
  async.series(
    [
      ...
      function(cb) {
        ...
        var options = { lean: true };
        Service.OpportunityDraftService.getOpportunityDraft(
          {
            active: true,
            employerId: customerData._id,
            company: customerData.companyId,
      ...
      function(cb) {
        if (
          ...
          dataToSave.company = customerData.companyId;
          dataToSave.publishDate = new Date().toISOString();
          Service.OpportunityDraftService.createOpportunityDraft(
            dataToSave,
            function(err, opportunityDataFromDB) {
              console.log("hello", err, opportunityDataFromDB);
              if (err) {
                cb(err);
              } else {
  ...
  async.series(
    [
      function(cb) {
        ...
        var options = { lean: true };
        Service.EmployerService.getEmployer(query, {}, options, function(
          err,
          data
        ) {
          if (err) {
            ...
            if (data.length == 0) cb(ERROR.INCORRECT_ACCESSTOKEN);
            else employerInfo = (data && data[0]) || null;
            cb();
          }
        });
      },
      ...
      function(cb) {
        ...
        var options = { lean: true };
        Service.OpportunityDraftService.getOpportunityDraft(
          { active: true, employerId: employerInfo._id },
          projection,
          options,
          function(err, data) {
            if (err) {
  ...
  async.series(
    [
      ...
      function(cb) {
        ...
        var options = { lean: true };
        Service.OpportunityService.getOpportunity(
          { _id: payloadData.opportunityId, employerId: userData._id },
          projection,
          options,
          function(err, data) {
            if (err) {
      ...
      function(callback) {
        ...
        var dataToUpdate = {
          $set: {
            positionTitle: payloadData.position,
            employmentType: payloadData.employmentType,
            location: payloadData.location,
        ...
        Service.OpportunityService.updateOpportunity(
          condition,
          dataToUpdate,
          {},
  ...
  async.series(
    [
      ...
      function(callback) {
        ...
        Service.OpportunityDraftService.updateOpportunityDraft(
          condition,
          dataToUpdate,
          {},
          function(err, opportunity) {
  ...
  async.series(
    [
      ...
      function(cb) {
        ...
        var options = { lean: true };
        Service.OpportunityDraftService.getOpportunityDraft(
          { active: true, _id: payloadData.draftId },
          projection,
          options,
          function(err, data) {
            if (err) {
        ...
        Service.OpportunityService.getOpportunity(
          {
            ...
            industryField: draft.industryField
          },
          projection,
          options,
          function(err, data) {
      ...
      function(cb) {
        dataToSave.publishDate = new Date().toISOString();
        Service.OpportunityService.createOpportunity(draft, function(
          err,
          opportunityDataFromDB
        ) {
          if (err) {
